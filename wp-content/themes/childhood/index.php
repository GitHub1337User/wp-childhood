<?php 
    ...
    ?>
                                ...
                                <div class="col-lg-7 offset-1">
                                   ...
                                   "><?php the_title();?></h2>
                                    ...
                                    <?php
                                            ...
                                            if($field=='on'){
                                                ?>
                                               <a href="<?php the_field('slider_lnk');?>" class="button">
                                                   Узнать больше
                                                </a>
                                                <?php
                                            }
        ...
        <div class="about" id="about">
         ...
         <!-- <?php 
                function test_action($number){
                    echo "Test action ".$number."</br>";

                };
                add_action('my_action','test_action',15);
                add_action('my_action','test_action',10);
                do_action('my_action','did action');
                remove_action('my_action',15);

                function test_filter($number){
                    return 'Test filter '.$number."</br>";
                }
                add_filter('my_filter',"test_filter");
                echo apply_filters('my_filter',0);
